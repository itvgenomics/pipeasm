...
rule final_contacts_bwa_mem2_index_prim:
    input:
        fasta="results/Scaffolding/YAHS_Scaffolding/Primary/{sample}.yahs_scaffolds_final.fa",
    output:
        "results/Scaffolding/YAHS_Scaffolding/Primary/{sample}.yahs_scaffolds_final.fa.bwt.2bit.64"
    log:
        "logs/{sample}.final_contacts_bwa_mem2_index_prim.txt"
    benchmark:
        "benchmarks/{sample}.final_contacts_bwa_mem2_index_prim.txt"
    singularity:
       f"{config["sif_dir"]}/hic_mapping.sif"
    shell:
        """
...
rule final_contacts_bwa_mem2_index_alt:
    input:
        fasta="results/Scaffolding/YAHS_Scaffolding/Alternative/{sample}.yahs_scaffolds_final.fa",
    output:
        "results/Scaffolding/YAHS_Scaffolding/Alternative/{sample}.yahs_scaffolds_final.fa.bwt.2bit.64"
    log:
        "logs/{sample}.final_contacts_bwa_mem2_index_alt.txt"
    benchmark:
        "benchmarks/{sample}.final_contacts_bwa_mem2_index_alt.txt"
    singularity:
       f"{config["sif_dir"]}/hic_mapping.sif"
    shell:
        """
...
rule final_contacts_bwa_mem2_mapping_prim_r1:
    input:
        fasta="results/Scaffolding/YAHS_Scaffolding/Primary/{sample}.yahs_scaffolds_final.fa",
        hic_r1="results/Trimming_QC/HiC/{sample}_R1.trimmed_paired.fastq.gz",
        index="results/Scaffolding/YAHS_Scaffolding/Primary/{sample}.yahs_scaffolds_final.fa.bwt.2bit.64",
    output:
        "results/Scaffolding/Final_Contacts/Primary/{sample}.R1.bam"
    log:
        "logs/{sample}.final_contacts_bwa_mem2_mapping_prim_r1.txt"
    benchmark:
        "benchmarks/{sample}.final_contacts_bwa_mem2_mapping_prim_r1.txt"
    params:
        tmpdir="results/Scaffolding/Final_Contacts/Primary/tmp1"
    singularity:
       f"{config["sif_dir"]}/hic_mapping.sif"
    shell:
        """
...
rule final_contacts_bwa_mem2_mapping_prim_r2:
    input:
        fasta="results/Scaffolding/YAHS_Scaffolding/Primary/{sample}.yahs_scaffolds_final.fa",
        hic_r2="results/Trimming_QC/HiC/{sample}_R2.trimmed_paired.fastq.gz",
        index="results/Scaffolding/YAHS_Scaffolding/Primary/{sample}.yahs_scaffolds_final.fa.bwt.2bit.64",
    output:
        "results/Scaffolding/Final_Contacts/Primary/{sample}.R2.bam"
    log:
        "logs/{sample}.final_contacts_bwa_mem2_mapping_prim_r2.txt"
    benchmark:
        "benchmarks/{sample}.final_contacts_bwa_mem2_mapping_prim_r2.txt"
    params:
        tmpdir="results/Scaffolding/Final_Contacts/Primary/tmp2"
    singularity:
       f"{config["sif_dir"]}/hic_mapping.sif"
    shell:
        """
...
rule final_contacts_bwa_mem2_mapping_alt_r1:
    input:
        fasta="results/Scaffolding/YAHS_Scaffolding/Alternative/{sample}.yahs_scaffolds_final.fa",
        hic_r1="results/Trimming_QC/HiC/{sample}_R1.trimmed_paired.fastq.gz",
        index="results/Scaffolding/YAHS_Scaffolding/Alternative/{sample}.yahs_scaffolds_final.fa.bwt.2bit.64",
    output:
        "results/Scaffolding/Final_Contacts/Alternative/{sample}.R1.bam"
    log:
        "logs/{sample}.final_contacts_bwa_mem2_mapping_alt_r1.txt"
    benchmark:
        "benchmarks/{sample}.final_contacts_bwa_mem2_mapping_alt_r1.txt"
    params:
        tmpdir="results/Scaffolding/Final_Contacts/Alternative/tmp1"
    singularity:
       f"{config["sif_dir"]}/hic_mapping.sif"
    shell:
        """
...
rule final_contacts_bwa_mem2_mapping_alt_r2:
    input:
        fasta="results/Scaffolding/YAHS_Scaffolding/Alternative/{sample}.yahs_scaffolds_final.fa",
        hic_r2="results/Trimming_QC/HiC/{sample}_R2.trimmed_paired.fastq.gz",
        index="results/Scaffolding/YAHS_Scaffolding/Alternative/{sample}.yahs_scaffolds_final.fa.bwt.2bit.64",
    output:
        "results/Scaffolding/Final_Contacts/Alternative/{sample}.R2.bam"
    log:
        "logs/{sample}.final_contacts_bwa_mem2_mapping_alt_r2.txt"
    benchmark:
        "benchmarks/{sample}.final_contacts_bwa_mem2_mapping_alt_r2.txt"
    params:
        tmpdir="results/Scaffolding/Final_Contacts/Alternative/tmp2"
    singularity:
       f"{config["sif_dir"]}/hic_mapping.sif"
    shell:
        """
...
rule final_contacts_bellerophon_merge_prim:
    input:
        bam_r1="results/Scaffolding/Final_Contacts/Primary/{sample}.R1.bam",
        bam_r2="results/Scaffolding/Final_Contacts/Primary/{sample}.R2.bam",
    output:
        "results/Scaffolding/Final_Contacts/Primary/{sample}.merged.bam"
    params:
        quality= config['bellerophon'],
    log:
        "logs/{sample}.final_contacts_bellerophon_merge_prim.txt"
    benchmark:
        "benchmarks/{sample}.final_contacts_bellerophon_merge_prim.txt"
    singularity:
       f"{config["sif_dir"]}/hic_mapping.sif"
    shell:
        """
...
rule final_contacts_bellerophon_merge_alt:
    input:
        bam_r1="results/Scaffolding/Final_Contacts/Alternative/{sample}.R1.bam",
        bam_r2="results/Scaffolding/Final_Contacts/Alternative/{sample}.R2.bam",
    output:
        "results/Scaffolding/Final_Contacts/Alternative/{sample}.merged.bam"
    params:
        quality= config['bellerophon'],
    log:
        "logs/{sample}.final_contacts_bellerophon_merge_alt.txt"
    benchmark:
        "benchmarks/{sample}.final_contacts_bellerophon_merge_alt.txt"
    singularity:
       f"{config["sif_dir"]}/hic_mapping.sif"
    shell:
        """
...
rule final_contacts_samtools_flagstats_prim:
    input:
        merged_bam="results/Scaffolding/Final_Contacts/Primary/{sample}.merged.bam",
    output:
        flagstats="results/Scaffolding/Final_Contacts/Primary/{sample}.merged.bam.flagstats",
        hic_stats="results/Scaffolding/Final_Contacts/Primary/{sample}.merged.bam.hic_stats"
    log:
        "logs/{sample}.final_contacts_samtools_flagstats_prim.txt"
    benchmark:
        "benchmarks/{sample}.final_contacts_samtools_flagstats_prim.txt"
    singularity:
       f"{config["sif_dir"]}/hic_mapping.sif"
    shell:
        """
...
rule final_contacts_samtools_flagstats_alt:
    input:
        merged_bam="results/Scaffolding/Final_Contacts/Alternative/{sample}.merged.bam",
    output:
        flagstats="results/Scaffolding/Final_Contacts/Alternative/{sample}.merged.bam.flagstats",
        hic_stats="results/Scaffolding/Final_Contacts/Alternative/{sample}.merged.bam.hic_stats"
    log:
        "logs/{sample}.final_contacts_samtools_flagstats_alt.txt"
    benchmark:
        "benchmarks/{sample}.final_contacts_samtools_flagstats_alt.txt"
    singularity:
       f"{config["sif_dir"]}/hic_mapping.sif"
    shell:
        """
...
rule final_contacts_pretext_map_snapshot_prim:
    input:
        merged_bam="results/Scaffolding/Final_Contacts/Primary/{sample}.merged.bam",
    output:
        "results/Scaffolding/Final_Contacts/Primary/{sample}.merged.bam.pretext"
    params:
        pretextmap= config['pretext']["map"],
        snapshot=  config['pretext']["snapshot"]
    log:
        "logs/{sample}.final_contacts_pretext_map_snapshot_prim.txt"
    benchmark:
        "benchmarks/{sample}.final_contacts_pretext_map_snapshot_prim.txt"
    singularity:
       f"{config["sif_dir"]}/hic_mapping.sif"
    shell:
        """
        samtools view -h {input.merged_bam} | PretextMap -o {output} {params.pretextmap} >> {log} 2>&1 && \
        PretextSnapshot -m {output} {params.snapshot} -o results/Scaffolding/Final_Contacts/Primary/ --prefix {wildcards.sample}.final_contacts_prim >> {log} 2>&1
        """

rule final_contacts_pretext_map_snapshot_alt:
    input:
        merged_bam="results/Scaffolding/Final_Contacts/Alternative/{sample}.merged.bam",
    output:
        "results/Scaffolding/Final_Contacts/Alternative/{sample}.merged.bam.pretext"
    params:
        pretextmap= config['pretext']["map"],
        snapshot=  config['pretext']["snapshot"]
    log:
        "logs/{sample}.final_contacts_pretext_map_snapshot_alt.txt"
    benchmark:
        "benchmarks/{sample}.final_contacts_pretext_map_snapshot_alt.txt"
    singularity:
       f"{config["sif_dir"]}/hic_mapping.sif"
    shell:
        """
        samtools view -h {input.merged_bam} | PretextMap -o {output} {params.pretextmap} >> {log} 2>&1 && \
        PretextSnapshot -m {output} {params.snapshot} -o results/Scaffolding/Final_Contacts/Alternative/ --prefix {wildcards.sample}.final_contacts_alt >> {log} 2>&1
        """
...
rule final_contacts_samtools_flagstats_bam_r1_prim:
    input:
        bam_r1="results/Scaffolding/Final_Contacts/Primary/{sample}.R1.bam",
    output:
        flagstats_r1="results/Scaffolding/Final_Contacts/Primary/{sample}.R1.bam.flagstats"
    params:
        pretextmap= config['pretext']["map"],
        snapshot=  config['pretext']["snapshot"]
    log:
        "logs/{sample}.final_contacts_samtools_flagstats_bam_r1_prim.txt"
    benchmark:
        "benchmarks/{sample}.final_contacts_samtools_flagstats_bam_r1_prim.txt"
    singularity:
       f"{config["sif_dir"]}/hic_mapping.sif"
    shell:
        """
...
rule final_contacts_samtools_flagstats_bam_r2_prim:
    input:
        bam_r2="results/Scaffolding/Final_Contacts/Primary/{sample}.R2.bam",
    output:
        flagstats_r2="results/Scaffolding/Final_Contacts/Primary/{sample}.R2.bam.flagstats"
    params:
        pretextmap= config['pretext']["map"],
        snapshot=  config['pretext']["snapshot"]
    log:
        "logs/{sample}.final_contacts_samtools_flagstats_bam_r2_prim.txt"
    benchmark:
        "benchmarks/{sample}.final_contacts_samtools_flagstats_bam_r2_prim.txt"
    singularity:
       f"{config["sif_dir"]}/hic_mapping.sif"
    shell:
        """
...
rule final_contacts_samtools_flagstats_bam_r1_alt:
    input:
        bam_r1="results/Scaffolding/Final_Contacts/Alternative/{sample}.R1.bam",
    output:
        flagstats_r1="results/Scaffolding/Final_Contacts/Alternative/{sample}.R1.bam.flagstats"
    params:
        pretextmap= config['pretext']["map"],
        snapshot=  config['pretext']["snapshot"]
    log:
        "logs/{sample}.final_contacts_samtools_flagstats_bam_r1_alt.txt"
    benchmark:
        "benchmarks/{sample}.final_contacts_samtools_flagstats_bam_r1_alt.txt"
    singularity:
       f"{config["sif_dir"]}/hic_mapping.sif"
    shell:
        """
...
rule final_contacts_samtools_flagstats_bam_r2_alt:
    input:
        bam_r2="results/Scaffolding/Final_Contacts/Alternative/{sample}.R2.bam",
    output:
        flagstats_r2="results/Scaffolding/Final_Contacts/Alternative/{sample}.R2.bam.flagstats"
    params:
        pretextmap= config['pretext']["map"],
        snapshot=  config['pretext']["snapshot"]
    log:
        "logs/{sample}.final_contacts_samtools_flagstats_bam_r2_alt.txt"
    benchmark:
        "benchmarks/{sample}.final_contacts_samtools_flagstats_bam_r2_alt.txt"
    singularity:
       f"{config["sif_dir"]}/hic_mapping.sif"
    shell:
        """
